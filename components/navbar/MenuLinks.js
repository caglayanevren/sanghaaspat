    ...
    return (
        <Box display={{ base: isOpen ? 'block' : 'none', md: 'block' }} flexBasis={{ base: '100%', md: 'auto' }}>
            <Stack spacing={[8, 8, 5, 10]} align="center" justify={['center', 'space-between', 'flex-end', 'flex-end']} direction={['column', 'column', 'row', 'row']} pt={[4, 4, 0, 0]}>
                ...
                {/* <ChangeColorMode /> */}
                <Stack direction={'row'}>
                    <Link href="https://www.facebook.com/bodrumqigong" isExternal aria-label="facebook">
                        <Icon as={FaFacebook} />
                    </Link>
                    <Link href="https://www.instagram.com/sanghaaspat/" isExternal aria-label="instagram">
                        <Icon as={FaInstagram} />
                    </Link>
                </Stack>
                <LocaleSwitcher />
